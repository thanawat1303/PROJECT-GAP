            ...
            <div className="box-login">
                <form onSubmit={this.submitFrom} className="content-login">
                    ...
                    <label className="content-user">
                        ...
                        <input onChange={this.changeValUs} className="inputForm" type="text" name="username" placeholder="รหัสประจำตัวผู้ส่งเสริม"/>
                    </label>
                    <label className="content-pw">
                        <span className="label-login">รหัสผ่าน</span>
                        <input onChange={this.changeValPw} className="inputForm" type="password" name="password" placeholder="รหัสผ่าน "/>
                    </label>
