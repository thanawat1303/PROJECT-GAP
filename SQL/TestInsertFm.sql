INSERT INTO line_chat_gap.acc_farmer(id_farmer,id_docter,fullname,img,station,location,password,register_auth,uid_line) VALUES ("" , "" , "สมศัก สีสวย" , "" , "ราชมงคล" , POINT(14,100) , SHA2("admin" , 256) , 0 , "")
