            ...
            <div className="menu-content" show={StateMenuShow ? "" : null}>
                ...
                <a title="ส่งออกข้อมูล" onClick={()=>{
                    ...
                    <svg viewBox="0 0 400 400" style={{
                        ...
                        <path d="M-30 136C-30 44.3207 44.3207 -30 136 -30H234C325.679 -30 400 44.3207 400 136C400 77.4578 339.111 30 264 30H136C77.4578 30 30 77.4578 30 136H-30ZM400 400H0H400ZM136 400C44.3207 400 -30 325.679 -30 234V136C-30 44.3207 44.3207 -30 136 -30V30C77.4578 30 30 77.4578 30 136V264C30 339.111 77.4578 400 136 400ZM400 0V400V0Z" fill="#196658" fillOpacity="0.698039" mask="url(#path-1-inside-1_1_57)"/>
                        ...
                        <path d="M365 295.64L152 295.64" stroke="#196658" strokeWidth="35" strokeLinecap="round"/>
