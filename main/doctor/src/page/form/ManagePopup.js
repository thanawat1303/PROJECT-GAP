...
import { DayJSX, Loading, PopupDom } from "../../../../../src/assets/js/module"
                                        ...
                                        <div className="data-row">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="data-main in-2">
                                                    ...
                                                    <span className="data-show">{data.seft}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    return (
        ...
        <div className="content-detail-form">
            ...
            <div className="menu-content">
                <a title="ข้อมูลพื้นฐาน" onClick={()=>ChangeTypePage(0)}>
                ...
                <a title="ปัจจัยการผลิต" onClick={()=>ChangeTypePage(1)}>
                ...
                <a title="สารเคมี" onClick={()=>ChangeTypePage(2)}>
                ...
                <a title="ส่วนเจ้าหน้าที่" onClick={()=>MenuManageFormByDoctor("success")}>
                ...
                { LoadContent ? 
                    ...
                    <div className="content-body">
                        <div className="head-content">
                            <div className="text">{TypePage === 0 ? "ข้อมูลการปลูกพืช" : TypePage === 1 ? "ข้อมูลการใช้ปัจจัยการผลิต" : TypePage === 2 ? "ข้อมูลการใช้สารเคมี" : "บันทึกเจ้าหน้าที่"}</div>
                            { TypePage === 0 ?
                                (
